    ...
    <Screen>
      ...
      <View style={styles.middle}>
        <Animated.Text style={[styles.headline, headlineStyle]}>
          Hey.{'\n'}
          <Text style={styles.headlineAccent}>A daily 8-minute drill for your attention.</Text>
        </Animated.Text>

        <Animated.Text style={[styles.sub, subStyle]}>
          Measured, not gamified. Six real skills. Six honest numbers. Never a made-up brain-age or IQ.
        </Animated.Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  sub: { ...type.body, color: colors.textMuted, marginTop: spacing(4) },
